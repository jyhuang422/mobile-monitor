...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Provider = __webpack_require__(451);

	var _Provider2 = _interopRequireDefault(_Provider);

	var _connect = __webpack_require__(453);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storeShape = __webpack_require__(452);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wrapActionCreators = __webpack_require__(455);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _combineReducers = __webpack_require__(462);

	var _combineReducers2 = _interopRequireDefault(_combineReducers);

	var _bindActionCreators = __webpack_require__(464);

	var _bindActionCreators2 = _interopRequireDefault(_bindActionCreators);

	var _applyMiddleware = __webpack_require__(465);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPrototype = __webpack_require__(459),
	    isHostObject = __webpack_require__(460),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FilterArea = __webpack_require__(470);

	var _FilterArea2 = _interopRequireDefault(_FilterArea);

	var _BrowserArea = __webpack_require__(472);

	var _BrowserArea2 = _interopRequireDefault(_BrowserArea);
	...
	var App = function App() {
	  return _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(_FilterArea2.default, null),
	    _react2.default.createElement(_BrowserArea2.default, null)
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FilterList = function FilterList(_ref) {
	  ...
	  var envs = _ref.envs;
	  var onEnvChange = _ref.onEnvChange;
	  var _onChange = _ref.onChange;
	  var onGroupChange = _ref.onGroupChange;
	  return _react2.default.createElement(
	    'div',
	    { id: 'filter-area' },
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', {
	            ...
	            onChange: function onChange() {
	              return data.type === 'page' ? _onChange(data.id) : onGroupChange(data.id, data.isShow);
	            },
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    onChange: function onChange(id) {
	      dispatch((0, _actions.setVisibility)(id));
	    },
	    onGroupChange: function onGroupChange(group_id, is_show) {
	      dispatch((0, _actions.setGroupVisibility)(group_id, is_show));
	    },
	    onEnvChange: function onEnvChange(env_id) {
	      dispatch((0, _actions.setEnv)(env_id));
	    }
	  };
	};

	var FilterArea = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(FilterList);
...
/***/ function(module, exports) {
	...
	var setVisibility = exports.setVisibility = function setVisibility(id) {
	  return {
	    type: 'SET_VISIBILITY',
	    id: id
	  };
	};
	var setGroupVisibility = exports.setGroupVisibility = function setGroupVisibility(group_id, is_show) {
	  return {
	...
	var setEnv = exports.setEnv = function setEnv(env_id) {
	  return {
	    type: 'SET_ENV',
	    env_id: env_id
	  };
...
/***/ function(module, exports, __webpack_require__) {
	      ...
	      env.forEach(function (env) {
	        if (env.isShow) {
	          markup.push(_react2.default.createElement(
	            'li',
	            { key: data.id + "_" + env.id, style: { display: data.isShow ? 'inline-block' : 'none' } },
	            _react2.default.createElement(
	              'h2',
	              null,
	              data.page_name + "--" + env.id,
	              '(',
	              _react2.default.createElement(
	                'a',
	                { className: 'btn-refresh', href: '#', onClick: refresh },
	                'refresh'
	              ),
	              ')'
	            ),
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    refresh: function refresh(e) {
	      e.preventDefault();
	      var target = e.target;
	      var ifr = target.parentNode.parentNode.children[1];
	      ifr.src = ifr.src;
	    }
	  };
	};
	...
	var BrowserArea = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(BrowserList);

	exports.default = BrowserArea;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _filters = __webpack_require__(474);

	var _filters2 = _interopRequireDefault(_filters);

	var _env = __webpack_require__(475);

	var _env2 = _interopRequireDefault(_env);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var monitorApp = (0, _redux.combineReducers)({
...
/***/ function(module, exports) {
	...
	var filters = function filters() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? window.context : arguments[0];
	  var action = arguments[1];
	  ...
	  switch (action.type) {
	    ...
	    default:
	      return state.map(function (st) {
	        return Object.assign({}, st, { showed: st.isShow });
	      });
	  }
	};
...
/***/ function(module, exports) {
	...
	var envs = function envs() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? window.env : arguments[0];
	  var action = arguments[1];

	  switch (action.type) {
	    case 'SET_ENV':
	      return state.map(function (env) {
